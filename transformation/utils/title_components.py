...
# Make sibling import work whether this module is loaded from transformation/
# or from transformation/utils/.
...
_TIME_PATTERNS = [
    ...
    # from YEAR to YEAR
    re.compile(rf"\bfrom\s+{YEAR_RE}\s+to\s+{YEAR_RE}\b", re.I),
    # - YEAR to YEAR
    re.compile(rf"-\s*{YEAR_RE}\s+to\s+{YEAR_RE}\b"),
    # during YR
